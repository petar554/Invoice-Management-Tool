...
export default function RegisterPage() {
  ...
  const calculatePasswordStrength = (password) => {
    ...
    const strengthMap = {
      ...
      6: { label: "Odlična", color: "bg-green-700" },
    };
  ...
  const validateForm = () => {
    ...
    if (passwordStrength.score < 3) {
      showWarning(
        "Lozinka je previše slaba. Koristite kombinaciju velikih i malih slova, brojeva i specijalnih karaktera."
      );
      return false;
    }

    if (!formData.confirmPassword) {
      showError("Potvrdite vašu lozinku");
      return false;
    }
    ...
    if (!acceptedTerms) {
      showError("Morate prihvatiti uslove korišćenja");
      return false;
    }
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (data?.user) {
        ...
        showInfo("Proverite vaš email za potvrdni link");
      ...
      showError("Nepoznata greška pri registraciji");
    } finally {
      setIsLoading(false);
    }
  };
